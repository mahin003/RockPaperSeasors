    ...
    function CountLoop(){
     ...
     countDown[i-1].style.display="none";
		...
		if(i==3 ){
           ...
           document.getElementById("rock").onclick = function() {rockBottom()};
           document.getElementById("paper").onclick = function() {paperBottom()};
           document.getElementById("seasors").onclick = function() {seasorBottom()};
